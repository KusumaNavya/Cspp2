...
class FitByte {
    ...
    public List<Waterlog> getWaterlog(int index) {
        return waterlog;
    }
    public List<Foodlog> getFoodlog(int index) {
        return foodlog;
    }
    public List<Sleeplog> getSleeplog(int index) {
        return sleeplog;
    }
    public List<Activitylog> getActivitylog(int index) {
        return activitylog;
    }
    ...
    public void addPA(Activitylog pa) {
        activitylog.add(pa);
    }
...
class Activitylog {
    ...
    Activitylog(String activityname, String type, String datetime, String starttime, String endtime) {
    ...
    public static void main(String[] args) {
        ...
        while (s.hasNext()) {
            ...
            case "PhysicalActivity":
                check = tokens[1].split(",");
                info.addPA(new Activitylog(check[0], check[1], check[2], check[3], check[4]));
                break;
            case "Weight":
                check = tokens[1].split(",");
